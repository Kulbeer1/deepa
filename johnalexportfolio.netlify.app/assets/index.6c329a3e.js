...
const u = function() {
    ...
    new MutationObserver(i => {
        for (const a of i)
            if (a.type === "childList")
                for (const c of a.addedNodes) c.tagName === "LINK" && c.rel === "modulepreload" && n(c)
    }).observe(document, {
        childList: !0,
        subtree: !0
    });
...
u();
var f = "/assets/hero.a707d92d.png";
const y = () => {
    const r = ["logo-instagram", "logo-facebook", "logo-linkedin", "logo-twitter"];
    return t("section", {
        id: "home",
        ...
        children: [e("div", {
            ...
            children: t("div", {
                ...
                children: [t("h1", {
                    ...
                    children: r == null ? void 0 : r.map(l => e("div", {
...
var b = "/assets/about.34cb49a4.png";
const v = () => e("section", {
        id: "about",
                ...
                children: [e("div", {
                    ...
                    children: t("div", {
                        ...
                        children: [e("p", {
                            ...
                            children: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa eos, quam vel quisquam, explicabo sit labore dignissimos optio ratione quibusdam doloribus pariatur consequuntur sint. Reprehenderit cupiditate possimus facere quasi voluptatem?"
                        }), e("div", {
        ...
        return e("section", {
            ...
            children: t("div", {
                ...
                children: [t("h3", {
                    ...
                    children: r == null ? void 0 : r.map((l, s) => t("div", {
                        className: "border-2 group border-cyan-600 relative min-w-[10rem] max-w-[16rem] bg-gray-900 p-10 rounded-xl",
                        children: [e("div", {
                            style: {
                                background: `conic-gradient(rgb(8,145,170) ${l.count}%,#ddd ${l.count}%)`
                            },
...
var w = "/assets/project-1.8f3963ea.png",
    j = "/assets/project-2.6a32d774.jpg",
    k = "/assets/project-3.cd7db3ec.jpg",
    S = "/assets/project-4.b976e709.jpg",
    C = "/assets/project-5.808bc575.png",
    M = "/assets/project_person1.718b85ad.png";
const _ = () => t("section", {
    id: "projects",
    className: "py-10 text-white",
    children: [t("div", {
...
var A = "/assets/hireMe.55b0f29b.png";
const q = () => t("section", {
        id: "hireme",
        ...
        children: [t("div", {
            ...
            children: [t("h3", {
                className: "text-4xl font-semibold",
                children: ["Hire ", e("span", {
                    className: "text-cyan-600",
                    children: "Me"
                })]
            }), e("p", {
                className: "text-gray-400 mt-3 text-lg",
                children: "Do you have any work?"
            })]
        }), t("div", {
            ...
            children: [t("div", {
                children: [e("h2", {
                    ...
                    children: "Do you want any work from me?"
                }), e("p", {
                    className: "lg:text-left text-justify max-w-lg text-sm mt-4 text-gray-200 leading-6",
                    children: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis dicta soluta quos tempore eos accusamus cupiditate, amet in similique sapiente obcaecati odio deleniti architecto corporis ratione. Consequatur a quidem maiores!"
                }), e("button", {
    ...
    O = () => e("section", {
        ...
        children: t("div", {
            ...
            children: [t("h3", {
                ...
                className: "mt-16 flex md:flex-row flex-col\r gap-6 max-w-5xl bg-gray-800 md:p-6 p-2 rounded-lg mx-auto",
                children: [t("form", {
                    ...
                    children: [{
                        ...
                        className: "flex flex-row  \r text-left gap-4 flex-wrap items-center",
                        children: [e("div", {
    ...
    P = () => e("div", {
        className: "bg-gray-800 text-sm p-4 text-center text-white",
        children: "Copyright \xA9 2022 John Alex.All Rights reserved."
    }),
    E = () => {
        const [r, l] = o.exports.useState(!1), [s, n] = o.exports.useState(!1), i = [{
            name: "HOME",
            link: "#home"
        }, {
            name: "ABOUT",
        ...
        return o.exports.useEffect(() => {
            window.addEventListener("scroll", () => {
                document.querySelector("nav"), window.scrollY > 0 ? l(!0) : l(!1)
            })
        }, []), e("nav", {
            className: `fixed w-full left-0 top-0 z-[999] ${r?"bg-white/60  text-gray-900":"text-white"}`,
            children: t("div", {
                ...
                children: [e("div", {
                    ...
                    className: ` ${r?"md:bg-white/0 bg-white":"bg-white"} text-gray-900 md:block hidden px-7 py-2 font-medium  rounded-bl-full`,
                    children: e("ul", {
                        className: "flex items-center gap-1 py-2 text-lg",
                        children: i == null ? void 0 : i.map((a, c) => e("li", {
                    ...
                    onClick: () => n(!s),
                    className: `z-[999]  ${s?"text-gray-900":"text-gray-100"} text-3xl md:hidden m-5`,
                    children: e("ion-icon", {
                        name: "menu"
                    })
                }), e("div", {
                    className: `md:hidden text-gray-900 absolute w-2/3 h-screen
      px-7 py-2 font-medium bg-white top-0 duration-300 ${s?"right-0":"right-[-100%]"}`,
                    children: e("ul", {
    ...
    B = () => t("div", {
        children: [e(E, {}), e(L, {}), e(y, {}), e(v, {}), e(N, {}), e(q, {}), e(_, {}), e(O, {}), e(P, {})]
    });
p.render(e(g, {
    children: e(B, {})
